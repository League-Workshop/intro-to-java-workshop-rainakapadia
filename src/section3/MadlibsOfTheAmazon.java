...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "If you find yourself having to cross a piranha-infested river, here is how you do it...");
...
String place= JOptionPane.showInputDialog("enter a place");
 ...
 JOptionPane.showMessageDialog(null, "Pirannhas are more "+adjective+" during the day,so crossthe river at\n"
